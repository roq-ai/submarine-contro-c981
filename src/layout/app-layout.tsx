...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiAnchor, FiBriefcase } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['submarine-captain', 'submarine-operator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Submarine', path: '/submarines', entity: 'submarine', service: AccessServiceEnum.PROJECT, icon: FiAnchor },
